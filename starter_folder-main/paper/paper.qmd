...
Using the open-source statistical programming language R [@citeR], this short paper will briefly analyze possible causes for low response rates in web surveys and provide methods to improve response rates. 
